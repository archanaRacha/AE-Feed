...
extension LocalFeedLoader{
    ...
    public func save(_ items : [LocalFeedImage],completion:@escaping(saveResults) -> Void){
    ...
    private func cache(_ items:[LocalFeedImage],with completion:@escaping (saveResults) -> Void){
